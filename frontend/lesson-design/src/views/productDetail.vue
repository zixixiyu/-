                ...
                <Col span = "10">
                    ...
                    <div>
                        <Card style="width:400px;margin-left: 95px">
                            ...
                            <InputNumber :min=0 :max="product.currentInventory" size="large" v-model="orderItem.productNum" controls-outside></InputNumber>
                    ...
                    <div>
                        <Card style="width:400px;margin-left: 95px">
                            ...
                            <DatePicker v-model="orderItem.beginAndEndTime" type="daterange" placement="bottom-end" placeholder="Select date" style="width: 200px"></DatePicker>
                        </Card>
                    </div>
                    <div>
                        <Card style="width:400px;margin-left: 95px">
